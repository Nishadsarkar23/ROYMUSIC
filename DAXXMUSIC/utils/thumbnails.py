...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("SANYAMUSIC/assets/font2.ttf", 30)
    font = ImageFont.truetype("SANYAMUSIC/assets/font.ttf", 30)
    title_font = ImageFont.truetype("SANYAMUSIC/assets/font3.ttf", 45)
    ...
    draw.text((10, 10), f"SANYA MUSIC", fill="white", font=font)
    ...
    play_icons = Image.open("SANYAMUSIC/assets/play_icons.png")
