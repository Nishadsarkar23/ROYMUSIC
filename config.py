...
OWNER_USERNAME = getenv("OWNER_USERNAME", @Kartik_NS")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "@ANIKAA_MUSIC_BOT")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "ANIKA MUSIC")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "NYKAA_ASS")
EVALOP = list(map(int, getenv("EVALOP", "6878447557").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002130435769"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/nishad_nn")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/thandar_ki_duniya")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/4a6d40f2d6cc9dcff3a7f.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://telegra.ph/file/15943e7e11d25fe6d6fdc.jpg"
)
